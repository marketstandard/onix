  ...
  (
    ...
    const failedMessage = (
      <p>
        ...
        at&nbsp;
        <Link href="mailto:eng@onix.chat" size="sm">
          eng@onix.chat
        </Link>
      </p>
    );
    ...
    return (
      <div {...props} ref={ref} className={cn('flex gap-3', className)}>
        <div className="relative flex-none">
          ...
          >
            <Avatar
              src={avatar}
              color="default"
              classNames={role === 'assistant' ? { base: 'bg-transparent' } : {}}
            />
          </Badge>
        </div>
        <div className="flex flex-col gap-4">
          ...
          >
            <Markdown
              className={`prose dark:prose-invert ${role === 'assistant' ? 'pr-8' : ''}`.trim()}
            >
              {(hasFailed ? failedMessage : message) as string}
            </Markdown>
